...
export default function Home() {
  ...
  function resetFields(targetDay: number) { setDay(targetDay); setPhase("create"); setStarted(false); setPreviewUrl(""); setTitle(""); setFeelings([]); setEnergy(3); setFocus("色彩"); setResponseMode("seen"); setNote(""); setError(""); setFeedbackOpen(false); setSharePreviewUrl(""); setShareMode("artTitle"); window.scrollTo({ top: 0, behavior: "smooth" }); }
